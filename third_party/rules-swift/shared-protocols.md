...
SHARED_PROTOCOLS_PATH="Sources/SharedProtocols"
[ -d "$SHARED_PROTOCOLS_PATH" ] || SHARED_PROTOCOLS_PATH="Packages/Sources/SharedProtocols"
for ln in $(grep -rn '^import ' "$SHARED_PROTOCOLS_PATH"/); do
