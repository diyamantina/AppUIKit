...
import Foundation
    ...
    public typealias TooltipHelper = AppUIKit.TooltipHelper
    ...
    public enum TooltipPosition {
        ...
        public func adjusted(for direction: LayoutDirection) -> TooltipPosition {
            switch self {
            case .leading:
                direction.isRTL ? .trailing : .leading
            case .trailing:
                direction.isRTL ? .leading : .trailing
            default:
                self
            }
        }
    ...
    public extension UIView {
        ...
        ///   - shortcut: The keyboard shortcut string (e.g., "⌘S").
        func setTooltipWithShortcut(_ tooltip: String, shortcut: String) {
            accessibilityHint = "\(tooltip) (\(shortcut))"
        }
