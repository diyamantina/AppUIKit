// AppUIKit.KeyboardShortcuts.swift
...
import Foundation
    ...
    public enum KeyboardShortcuts {
        ...
        public enum CanvasZoom {
            ...
            public static var resetDescription: String {
                "⇧Z"
            }
        }
        ...
        public enum NodeOperations {
            ...
            public static var selectAllDescription: String {
                "⌘A"
            }

            public static var duplicateDescription: String {
                "⌘D"
            }
        }
        ...
        public enum FileOperations {
            ...
            /// Human-readable descriptions
            public static var newDescription: String {
                "⌘N"
            }

            public static var openDescription: String {
                "⌘O"
            }

            public static var saveDescription: String {
                "⌘S"
            }

            public static var saveAsDescription: String {
                "⌘⇧S"
            }
        }
        ...
        public enum EditOperations {
            ...
            /// Human-readable descriptions
            public static var undoDescription: String {
                "⌘Z"
            }

            public static var redoDescription: String {
                "⌘⇧Z"
            }

            public static var copyDescription: String {
                "⌘C"
            }

            public static var cutDescription: String {
                "⌘X"
            }

            public static var pasteDescription: String {
                "⌘V"
            }
        }
    }
